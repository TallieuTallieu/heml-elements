...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } // eslint-disable-line no-unused-vars
export default exports["default"] = (0, _utils.createElement)('img', {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 5:
            attrs["class"] += " ".concat(isBlock ? 'img__block' : 'img__inline');
            attrs.style = isBlock ? '' : 'display: inline-block;';
            return _context.abrupt("return", [/*#__PURE__*/React.createElement("img", (0, _lodash.omit)(attrs, 'inline', 'infer')), /*#__PURE__*/React.createElement(_Style["default"], {
              "for": "img"
            }, "\n        .img__block {\n          display: block;\n          max-width: 100%;\n        }\n      ")]);
          case 8:
          case "end":
...
function getWidth(_x, _x2) {
  return _getWidth.apply(this, arguments);
}
function _getWidth() {
  _getWidth = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(path, isRetina) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return (0, _isAbsoluteUrl["default"])(path) ? getRemoteBuffer(path) : _fsExtra["default"].readFile(path);
        case 3:
          image = _context2.sent;
          _sizeOf = (0, _imageSize["default"])(image), width = _sizeOf.width;
          if (width) {
            _context2.next = 7;
            break;
          }
